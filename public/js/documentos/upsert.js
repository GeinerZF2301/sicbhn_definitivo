$(document).ready(function () {
    ...
    $("#create-button").click(function () {
        let method = "create";
        $("#create-modal-title").html("Crear un documento");
        ...
        $.ajax({
            ...
            error: function (error) {
                if (error.status === 422) {
                    ...
                    if (errors.hasOwnProperty("tipo_documento")) {
                        $("#tipo_documento_error").html(errors.tipo_documento[0]);
                    }
    ...
    $(".editBtn").click(function (e) {
        let url = '/documentos/{id}/edit';
        e.preventDefault();
        $("#edit-modal-title").html("Actualizar Documento");
    ...
    $(".updateBtn").click(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: '/documentos/update/'+ idRequest,
            data: formEdit,
            processData: false,
            contentType: false,
            success: function (response) {
...
function obtenerRegistroPorId(url, id) {
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#edit_tipo_documento").val(response.tipo_documento);
