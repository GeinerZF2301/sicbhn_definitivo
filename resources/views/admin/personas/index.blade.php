    ...
    <section>
        <div class="row mx-auto py-4 d-flex justify-content-center">
            <span class="mb-4 col-20">
                <h1 class="py-2 text-center text-dark mt-4 fs-2 rounded fw-bold text-uppercase">Gestión de Personas del
                    Corredor
                    Biológico</h1>
            </span>
            <div class="row mb-2">
            ...
            <div class="row">
                <div class="d-flex justify-content mt-2 ">
                    ...
                    <a href="/PDF-Personas" target="_blank" class="btn btn-primary mx-2"> <i class="fas fa-file-pdf"></i>
                        Generar reporte</a>
                </div>
            </div>
                                    ...
                                    @foreach ($personas as $persona)
                                        <tr>
                                            ...
                                            <td name="tipo_persona" class="budget">
                                                <span class="bg-success text-light rounded-pill p-2"> {{ $persona->estado }}
                                                </span>
                                            </td>
