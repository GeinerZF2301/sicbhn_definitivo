...
<head>
    <title>Reporte de Voluntarios del CBHN</title>
...
<body>
    ...
    <div class="title2">REPORTE DE GESTIÓN DE VOLUNTARIOS</div>
    ...
    <table class="table table-bordered">
        ...
        @foreach ($Voluntariados as $voluntariado)
            <tr>
                ...
                <td style="width: 10%" class="id" name="id" class="budget">{{ $voluntariado->id }}</td>
