                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="articulo_id  form-select form-select-sm" name="articulo_id"
                                    id="articulo_id" aria-label=".form-select-sm example">
                                    <option selected>Selecciona una opcion</option>
                                </select>
                                <span id="articulo_id_error" class="text-danger fw-bolder error-messages"></span>
                            </div>
