    ...
    <div class="row mx-auto py-4 d-flex justify-content-center">
        ...
        <div class="row">
            <div class="d-flex justify-content mt-2 ">
                ...
                @can('crear-usuario')
                    <a style="margin-bottom: 1rem;" href="{{ route('usuarios.create') }}" class="btn btn-success"> <i
                            class="fas fa-plus"></i> Crear usuario</a>
                @endcan
                <a style="margin-bottom: 1rem;" href="/PDF-Usuarios" target="_blank" class="btn btn-primary mx-2"> <i
                        ...
                        <tbody>
                            @foreach ($usuarios as $usuario)
                                <tr class="">
                                    ...
                                    <td>
                                        @can('editar-usuario')
                                            <a class="editBtn rounded btn btn-warning"
