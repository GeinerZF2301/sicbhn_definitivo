    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-4 px-lg-5 wow fadeIn"
        ...
        <div class="collapse navbar-collapse py-4 py-lg-0" id="navbarCollapse">
            <div class="navbar-nav ms-auto">
                <a href="{{ url('/home') }}" class="nav-item nav-link active">{{ __('messages.NavBarInicio') }}</a>
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">{{ __('messages.NavBarSobreNosotros') }}</a>

                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        <a href="{{ url('/sobrenosotros') }}" class="dropdown-item"> {{ __('messages.NavBarSobreNosotros') }}</a>
                        <a href="{{ url('/galeria') }}" class="dropdown-item">{{ __('messages.NavBarDropDownGaleria') }}</a>
                        <a href="{{ url('/horavisita') }}" class="dropdown-item"> {{ __('messages.NavBarDropDownHorasVisita') }} </a>
                        <a href="{{ url('/documentos') }}" class="dropdown-item">{{ __('messages.NavBarDropDownHorasDocumentacion') }}</a>
                    </div>
                </div>
...
=======
            ...
            @guest
                @if (Route::has('login'))
                    <a href="{{ route('login') }}" class="btn btn-success">{{ __('messages.NavBarBotonLogin') }}<i class="fa fa-right ms-0"></i></a>
                @endif
