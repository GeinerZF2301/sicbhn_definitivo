    ...
    <div class="container-scroller d-flex">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#request" aria-expanded="false"
                    ...
                    <div class="collapse" id="request">
                        <ul class="nav flex-column sub-menu">
                            @can('ver-Persona/Solicitudes')
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/solicitudesvoluntarios') }}">
                                        Solicitud de Voluntariados
                                    </a></li>
                            @endcan
                            @can('ver-Persona/Solicitudes')
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/solicitudestalleres') }}">Solicitud
                                        de Talleres</a></li>
                            @endcan
                        </ul>
                    </div>
                    ...
                    <div class="collapse" id="chartjs">
                        <ul class="nav flex-column sub-menu">
                            ...
                            @can('ver-Taller/Historial')
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/gestiontalleres') }}">Gestión
                                        de los
                                        Talleres</a></li>
                            @endcan
                        </ul>
                        ...
                        <ul class="nav flex-column sub-menu">
                            @can('ver-DonacionMonetarias')
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ url('/donacionMonetaria') }}">Monetarias</a></li>
                            @endcan
                            @can('ver-DonacionEspecies')
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/donacionEspecie') }}">En
                                        Especie</a></li>
                            @endcan
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#historial" aria-expanded="false"
                    ...
                    <div class="collapse" id="historial">
                        <ul class="nav flex-column sub-menu">
                            @can('ver-Voluntarios/Historial')
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/historialvoluntarios') }}">
                                        Participantes Voluntarios</a>
                                </li>
                            @endcan
                            @can('ver-Taller/Historial')
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/historialtalleres') }}">
                                        Participantes Talleres</a></li>
                            </ul>
                        @endcan
                    </div>
                </li>
                ...
                <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                    ...
                    <div class="navbar-brand-wrapper">
                        ...
                        <a class="navbar-brand brand-logo-mini" href="index.html"><img
                                src="../zoofari/img/LogoCorredor.webp" alt="logo" /></a>
                    </div>
                    <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">¡Bienvenido {{ Auth::user()->name }} !</h4>
