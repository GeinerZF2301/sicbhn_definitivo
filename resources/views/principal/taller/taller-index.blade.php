                ...
                <div class="row g-4 mb-4">
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                            <h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up">{{$cantidadTalleres}}</h1>
                            <div class="ps-4">
        ...
        <div class="col-sm-12 col-md-6  col-lg-4">
            ...
            <div class="cardv">
                <div class="cardv-title mt-2">
                    <input id="id" class="id" name="id" type="hidden" value="{{ $talleresDisponible->id }}">
                                ...
                                <form id="requestForm">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <span class="text-danger fs-5 ">*</span>
                                            <div class="form-floating">
                                                <input type="text" class="form-control bg-light border-0" id="apellidos"
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="int" class="form-control bg-light border-0" id="calle"
