        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">
                        La ayuda proporcionada al Corredor Biológico Hojancha-Nandayure, es una manera significativa de
                        contribuir a la conservación y protección de la biodiversidad y los ecosistemas de la región.<br>
