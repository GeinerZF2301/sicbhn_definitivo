        ...
        <div class="col-sm-12 col-md-6  col-lg-4">
            <div class="cardv">
                <div class="cardv-title mt-2">
                    <h5 class="text-center"> ¡Voluntariado en <font color="#028A0F">
                            {{$voluntariadosDisponible->nombre}}!</font>
                    </h5>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                ...
                <img src="zoofari/img/voluntariado/Voluntariados9.jpg" class="custom-text-box-image img-fluid" alt="">
            </div>
                            ...
                            <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <form id="requestForm">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="text" class="form-control bg-light border-0" id="lastname"
                                                    name="apellidos" placeholder="Your Lastname" />
                                                <label for="apellidos">Apellidos</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <label for="lastname">Tipo de Identificacion</label>
                                            <select class="form-select bg-light form-select mb-3 "
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="int" class="form-control bg-light border-0" id="edad"
                                                    name="edad" placeholder="Your Lastname" />
                                                <label for="lastname">Edad</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="text" class="form-control bg-light border-0" id="pais"
                                                    name="pais" placeholder="Your Lastname" />
                                                <label for="lastname">Pais</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="int" class="form-control bg-light border-0" id="ciudad"
                                                    name="ciudad" placeholder="Your Lastname" />
                                                <label for="lastname">Provincia o Ciudad</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="int" class="form-control bg-light border-0" id="distrito"
                                                    name="calle" placeholder="Your Lastname" />
                                    ...
                                    <div class="col-12">
                                        <div class=" mt-3 form-floating">
                                            <select id="tipo_voluntariado_id" class="form-select bg-light form-select mb-3 "
                                                name="tipo_identificacion" id="tipoIdentificacion"
                                                aria-label=".form-select example"">
                            
                                                    <option selected>Selecciona una opcion</option>
                                                    @foreach ($voluntariadosDisponibles as $voluntariadoDisponible )
                                                    <option value="{{$voluntariadoDisponible->id}}">{{$voluntariadoDisponible->nombre}}
                                                    </option>
                                                    @endforeach
                                            </select>
